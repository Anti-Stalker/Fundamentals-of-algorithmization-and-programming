...
public:
    ...
    void balanceTree();
    void findSumAndCount(TreeNode* node, int& sum, int& count);
    void findClosestNode(TreeNode* node, double average, TreeNode*& closestNode, double& closestDistance);
    double findAverageKey();
    int findClosestToAverage();
