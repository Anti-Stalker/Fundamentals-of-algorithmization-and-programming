...
{
    QString data = tree.searchStringByKey(ui->spb_findValue->value());
...
void MainWindow::on_bnt_cnt_of_list_clicked()
{
    ...
    double v = tree.findAverageKey();
    int d = tree.findClosestToAverage();
    QMessageBox::information(this, "Среднее значение всех ключей: " + QString::number(v) + " Ближайший ключ: " + QString::number(d)  , "Среднее значение всех ключей: " + QString::number(v) + " Ближайший ключ: " + QString::number(d) );
}
